...
Certification <br>
<input type="checkbox" name="certificate[]" value="nurse"> Nurse <br>
<input type="checkbox" name="certificate[]" value="childrearing"> Childrearing <br>
<input type="checkbox" name="certificate[]" value="consultation"> Consultation <br><br>
